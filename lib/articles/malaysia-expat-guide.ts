...
Malaysian tax residents are taxed on Malaysian-sourced income only — Malaysia operates a territorial tax system. Foreign-sourced income received in Malaysia by a resident individual came into charge in principle from 1 January 2022, but an exemption order has kept it exempt throughout, and that exemption was extended by P.U.(A) 451/2024 to run until **31 December 2036**. The condition attached is important and often left out: the income must already have been subject to tax of a similar character in the country where it arose, with documentation to support it. It is relief from double taxation, not a route to paying tax nowhere. For most salaried employees working for a Malaysian employer, the practical impact is confined to local employment income.
